...
// Logger implements the logr interface and logs to testing.T to preserve the order of log lines in tests.
type Logger struct {
	t      *testing.T
	names  []string
...
// NewLogger returns a new Logger writing to testing.T.
...
func (l *Logger) Info(msg string, kvs ...interface{}) {
	l.t.Helper() // exclude this method from stacktrace
